...
const documentChecklist: DocumentStatus[] = [
  { name: "Acceptance Letter", status: "completed", uploaded: true },
  { name: "Bank Statements", status: "completed", uploaded: true },
  { name: "Passport", status: "completed", uploaded: true },
  { name: "Official Transcripts", status: "warning" },
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-start max-w-[400px] mx-auto pb-32 relative">
      ...
      <header className="sticky top-0 z-20 w-full bg-white border-b border-gray-200 flex items-center px-4 py-3" style={{ maxWidth: 400 }}>
        ...
        <h1 className="text-base font-semibold text-gray-900 flex-1 text-center ml-[-2.5rem]">Build Your Application</h1>
      </header>
