  ...
  return (
    <div className="max-w-sm mx-auto bg-white min-h-screen relative">
      ...
      <section className="px-4 py-8 text-center">
        <div className="mb-6">
          <div className="w-16 h-16 bg-canadian-red rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <Button 
          ...
          className="w-full bg-professional-blue text-white py-3 px-6 rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-md"
        >
      ...
      <section className="px-4 py-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Why Choose VisaFlow?</h2>
        ...
        <div className="text-center mb-6">
          ...
          <div className="flex justify-center space-x-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-professional-blue">2,847</div>
              <div className="text-xs text-gray-600">Students Helped</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-professional-blue flex items-center justify-center">
                <span>4.9</span>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-professional-blue">94%</div>
        ...
        <Card className="shadow-sm">
          <CardContent className="p-4">
            ...
            <p className="text-sm text-gray-700 italic">
              "VisaFlow made the entire process so much easier. I was confused about which documents I needed, but their checklist was perfect. Got my study permit approved in just 6 weeks!"
            </p>
          </CardContent>
        </Card>
      </section>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-center text-xs font-medium text-professional-blue uppercase tracking-wider">VisaFlow</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td className="px-3 py-2 text-center text-xs text-professional-blue font-medium">$99</td>
              </tr>
              <tr>
                ...
                <td className="px-3 py-2 text-center text-xs text-professional-blue font-medium">Fast</td>
              </tr>
              <tr>
      ...
      {/* Final CTA */}
      <section className="px-4 py-8 bg-gradient-to-br from-professional-blue to-blue-700">
        <div className="text-center text-white">
          ...
          <Button 
            onClick={handleNavigateToUpload}
            className="w-full bg-white text-professional-blue py-3 px-6 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg"
          >
            Get Started Now
            <ArrowRight className="w-4 h-4 ml-2" />
          </Button>
      ...
      <footer className="px-4 py-6 bg-gray-800 text-center">
        <div className="flex items-center justify-center space-x-2 mb-3">
          <div className="w-6 h-6 bg-canadian-red rounded-full flex items-center justify-center">
            <span className="text-white text-xs">🍁</span>
          </div>
          <span className="text-white font-medium">VisaFlow</span>
        </div>
